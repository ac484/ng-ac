 ...
 *   "purpose": "合約統計卡片組件-展示合約統計數據",
 *   "constraints": ["Material Design", "響應式設計", "數據可視化"],
 *   "dependencies": ["MatCardModule", "MatIconModule", "ContractStats"],
 *   "security": "low",
 *   "lastmod": "2025-08-19"
 * }
 * @usage <app-contracts-dashboard-stats [stats]="contractStats"></app-contracts-dashboard-stats>
