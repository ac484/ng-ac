...
export class OptimizedTransaction extends OptimizedAggregateRoot {
  ...
  static create(
    ...
    transaction.addDomainEvent(new TransactionCreatedEvent(transaction.id, accountId, amount.getAmount(), transactionType));
  ...
  complete(): void {
    ...
    this.addDomainEvent(new TransactionProcessedEvent(this.id, this.accountId, this.amount.getAmount(), this.getTotalAmount().getAmount()));
  }
  ...
  fail(reason?: string): void {
    ...
    this.addDomainEvent(new TransactionFailedEvent(this.id, this.accountId, this.amount.getAmount(), reason || '未知錯誤'));
  }
  ...
  cancel(reason?: string): void {
    ...
    this.addDomainEvent(new TransactionCancelledEvent(this.id, this.accountId, reason || '用戶取消'));
  }
  ...
  static createDeposit(
    ...
    return OptimizedTransaction.create(transactionNumber, accountId, userId, amount, TransactionType.DEPOSIT, description, id);
  }
  ...
  static createWithdrawal(
    ...
    return OptimizedTransaction.create(transactionNumber, accountId, userId, amount, TransactionType.WITHDRAWAL, description, id);
  }
  ...
  static createTransfer(
    ...
    return OptimizedTransaction.create(transactionNumber, accountId, userId, amount, TransactionType.TRANSFER, description, id);
  }
}
