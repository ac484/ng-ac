  ...
  describe('business methods', () => {
    ...
    describe('updateDescription', () => {
      ...
      it('should throw error when transaction is completed', () => {
        ...
        expect(() => transaction.updateDescription('New description')).toThrowError('已完成的交易不能修改');
      });
    });
    ...
    describe('updateCategory', () => {
      ...
      it('should throw error when transaction is completed', () => {
        ...
        expect(() => transaction.updateCategory('New category')).toThrowError('已完成的交易不能修改');
      });
    });
    ...
    describe('addFees', () => {
      ...
      it('should throw error when currencies do not match', () => {
        ...
        expect(() => transaction.addFees(differentCurrencyFees)).toThrowError('手續費貨幣必須與交易金額貨幣一致');
      });

      it('should throw error when transaction is completed', () => {
        transaction.status = TransactionStatus.COMPLETED;

        expect(() => transaction.addFees(fees)).toThrowError('已完成的交易不能修改');
      });
    });
  ...
  describe('static factory methods', () => {
    describe('createDeposit', () => {
      it('should create deposit transaction', () => {
        const transaction = OptimizedTransaction.createDeposit('DEP-001', 'account-123', 'user-456', amount, 'Deposit transaction');
    ...
    describe('createWithdrawal', () => {
      it('should create withdrawal transaction', () => {
        const transaction = OptimizedTransaction.createWithdrawal('WTH-001', 'account-123', 'user-456', amount, 'Withdrawal transaction');
    ...
    describe('createTransfer', () => {
      it('should create transfer transaction', () => {
        const transaction = OptimizedTransaction.createTransfer('TRF-001', 'account-123', 'user-456', amount, 'Transfer transaction');
