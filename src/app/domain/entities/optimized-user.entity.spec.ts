import { OptimizedUser, CreateUserData } from './optimized-user.entity';

describe('OptimizedUser', () => {
  describe('create', () => {
    it('should create a new user with valid data', () => {
      ...
      // Act
      const user = OptimizedUser.create(userData);
    ...
    it('should create anonymous user', () => {
      // Act
      const user = OptimizedUser.createAnonymous();
  ...
  describe('business logic', () => {
    it('should determine if user can perform actions', () => {
      // Arrange
      const activeUser = OptimizedUser.create({
        email: 'test@example.com',
        displayName: 'Test User'
      });
