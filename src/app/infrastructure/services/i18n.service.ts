...
export class I18NService extends AlainI18nBaseService {
  ...
  /**
   * Get the default language based on platform and settings
   */
   ...
   * Fetches language-specific JSON files from the assets directory
   */
   ...
   * Registers locale data and updates all i18n services
   */
   ...
   * Returns list of supported languages with their display information
   */
