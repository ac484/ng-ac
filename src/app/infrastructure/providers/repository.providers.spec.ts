...
describe('Repository Providers', () => {
  ...
  describe('provideRepositoriesForTesting', () => {
    ...
    it('should provide working repository instances for testing', () => {
      TestBed.configureTestingModule({
        providers: [...provideRepositoriesForTesting(), { provide: Firestore, useValue: mockFirestore }]
      });
  ...
  describe('Integration Test', () => {
    it('should work with different configurations', () => {
      ...
      TestBed.configureTestingModule({
        providers: [...provideRepositories({ useMockRepositories: false }), { provide: Firestore, useValue: mockFirestore }]
      });
