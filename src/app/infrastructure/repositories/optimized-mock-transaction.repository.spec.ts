...
describe('OptimizedMockTransactionRepository', () => {
  ...
  describe('findByAccountId', () => {
    it('should find transactions by account ID', async () => {
      ...
      const transaction1 = OptimizedTransaction.createDeposit('TXN-001', accountId, 'user_1', new Money(1000, 'USD'), 'Transaction 1');
      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-002', accountId, 'user_1', new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('findByUserId', () => {
    it('should find transactions by user ID', async () => {
      ...
      const transaction1 = OptimizedTransaction.createDeposit('TXN-001', 'acc_1', userId, new Money(1000, 'USD'), 'Transaction 1');
      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-002', 'acc_2', userId, new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('findByAmountRange', () => {
    ...
    it('should return transactions sorted by amount descending', async () => {
      // Arrange
      const transaction1 = OptimizedTransaction.createDeposit('TXN-1', 'acc_1', 'user_1', new Money(1000, 'USD'), 'Transaction 1');

      const transaction2 = OptimizedTransaction.createDeposit('TXN-2', 'acc_2', 'user_2', new Money(2000, 'USD'), 'Transaction 2');
  ...
  describe('existsByTransactionNumber', () => {
    it('should return true when transaction exists', async () => {
      // Arrange
      const transaction = OptimizedTransaction.createDeposit('EXISTING-TXN', 'acc_1', 'user_1', new Money(1000, 'USD'), '存在的交易');
      await repository.save(transaction);
  ...
  describe('getStatistics', () => {
    it('should calculate statistics correctly', async () => {
      ...
      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-2', 'acc_2', 'user_2', new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('getAccountStatistics', () => {
    it('should calculate account statistics correctly', async () => {
      // Arrange
      const accountId = 'test_account';
      const transaction1 = OptimizedTransaction.createDeposit('TXN-1', accountId, 'user_1', new Money(1000, 'USD'), 'Transaction 1');
      transaction1.complete();

      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-2', accountId, 'user_1', new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('getUserStatistics', () => {
    it('should calculate user statistics correctly', async () => {
      // Arrange
      const userId = 'test_user';
      const transaction1 = OptimizedTransaction.createDeposit('TXN-1', 'acc_1', userId, new Money(1000, 'USD'), 'Transaction 1');
      transaction1.complete();

      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-2', 'acc_2', userId, new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('getTransactionHistoryReport', () => {
    it('should generate transaction history report correctly', async () => {
      ...
      const transaction2 = OptimizedTransaction.createWithdrawal('TXN-2', 'acc_1', 'user_1', new Money(500, 'USD'), 'Transaction 2');
  ...
  describe('search criteria filtering', () => {
    beforeEach(async () => {
      ...
      const transactions = [
        ...
        OptimizedTransaction.createWithdrawal('TXN-002', 'acc_1', 'user_1', new Money(500, 'USD'), 'Withdrawal transaction'),
        OptimizedTransaction.createTransfer('TXN-003', 'acc_2', 'user_2', new Money(2000, 'EUR'), 'Transfer transaction')
      ];
  ...
  describe('sorting', () => {
    beforeEach(async () => {
      ...
      const transactions = [
        OptimizedTransaction.createDeposit('TXN-A', 'acc_1', 'user_1', new Money(1000, 'USD'), 'Transaction A'),
        OptimizedTransaction.createWithdrawal('TXN-B', 'acc_2', 'user_2', new Money(3000, 'USD'), 'Transaction B'),
        OptimizedTransaction.createTransfer('TXN-C', 'acc_3', 'user_3', new Money(2000, 'USD'), 'Transaction C')
      ];
