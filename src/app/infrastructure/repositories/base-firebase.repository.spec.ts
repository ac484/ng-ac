...
describe('BaseFirebaseRepository', () => {
  ...
  describe('logging', () => {
    it('should log operations', () => {
      ...
      // Assert
      expect(console.log).toHaveBeenCalledWith('[test-collectionRepository] test-operation:', { test: 'data' });
    });
    ...
    it('should log errors', () => {
      ...
      // Assert
      expect(console.error).toHaveBeenCalledWith('[test-collectionRepository] test-operation failed:', {
        error: 'Test error',
