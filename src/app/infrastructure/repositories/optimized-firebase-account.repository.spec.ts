...
describe('OptimizedFirebaseAccountRepository', () => {
    ...
    beforeEach(() => {
        ...
        TestBed.configureTestingModule({
            providers: [
                OptimizedFirebaseAccountRepository,
    ...
    describe('findByAccountNumber', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.findByAccountNumber(accountNumber))
                .toBeRejectedWithError(RepositoryError, '根據帳戶號碼查找帳戶失敗');
        });
    });
    ...
    describe('findByUserId', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            await expectAsync(repository.findByUserId(userId))
                .toBeRejectedWithError(RepositoryError, '根據用戶 ID 查找帳戶失敗');
        });
    });
    ...
    describe('findByStatus', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            await expectAsync(repository.findByStatus(status))
                .toBeRejectedWithError(RepositoryError, '根據帳戶狀態查找帳戶失敗');
        });
    });
    ...
    describe('findByType', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.findByType(accountType))
                .toBeRejectedWithError(RepositoryError, '根據帳戶類型查找帳戶失敗');
        });
    });
    ...
    describe('findByBalanceRange', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.findByBalanceRange(minBalance, maxBalance))
                .toBeRejectedWithError(RepositoryError, '根據餘額範圍查找帳戶失敗');
        });
    });
    ...
    describe('findByCurrency', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.findByCurrency(currency))
                .toBeRejectedWithError(RepositoryError, '根據貨幣查找帳戶失敗');
        });
    });
    ...
    describe('existsByAccountNumber', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.existsByAccountNumber(accountNumber))
                .toBeRejectedWithError(RepositoryError, '檢查帳戶號碼是否存在失敗');
        });
    });
    ...
    describe('getStatistics', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            await expectAsync(repository.getStatistics())
                .toBeRejectedWithError(RepositoryError, '獲取帳戶統計資料失敗');
        });
    });
    ...
    describe('getUserAccountSummary', () => {
        ...
        it('should throw RepositoryError on failure', async () => {
            ...
            // Act & Assert
            await expectAsync(repository.getUserAccountSummary(userId))
                .toBeRejectedWithError(RepositoryError, '獲取用戶帳戶摘要失敗');
        });
    });
