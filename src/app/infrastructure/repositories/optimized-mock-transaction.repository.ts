...
export class OptimizedMockTransactionRepository extends BaseMockRepository<OptimizedTransaction> {
  ...
  protected initializeMockData(): void {
    const mockTransactions = [
      OptimizedTransaction.createDeposit('TXN-001001-DEP001', 'acc_1', 'user_1', new Money(1000, 'USD'), '初始存款', 'txn_1'),
      OptimizedTransaction.createWithdrawal('TXN-001002-WTH001', 'acc_1', 'user_1', new Money(500, 'USD'), 'ATM 提款', 'txn_2'),
      OptimizedTransaction.createTransfer('TXN-001003-TRF001', 'acc_2', 'user_2', new Money(2000, 'USD'), '轉帳至儲蓄帳戶', 'txn_3'),
      ...
      OptimizedTransaction.create('TXN-001006-FEE001', 'acc_1', 'user_1', new Money(25, 'USD'), TransactionType.FEE, '月度維護費', 'txn_6'),
      OptimizedTransaction.createDeposit('TXN-001007-DEP002', 'acc_1', 'user_1', new Money(750, 'USD'), '失敗的存款嘗試', 'txn_7'),
      OptimizedTransaction.createWithdrawal('TXN-001008-WTH002', 'acc_2', 'user_2', new Money(1200, 'USD'), '取消的提款', 'txn_8'),
      OptimizedTransaction.createDeposit('TXN-001009-DEP003', 'acc_3', 'user_3', new Money(5000, 'EUR'), '歐元存款', 'txn_9'),
      OptimizedTransaction.createTransfer('TXN-001010-TRF002', 'acc_3', 'user_3', new Money(800, 'EUR'), '國際轉帳', 'txn_10')
    ];
