...
// 測試用的應用服務
class TestApplicationService extends BaseApplicationService<
    TestEntity,
    TestCreateDto,
    TestUpdateDto,
    TestResponseDto
...
describe('BaseApplicationService', () => {
    ...
    describe('create', () => {
        ...
        it('當 DTO 無效時應該拋出 ValidationError', async () => {
            ...
            // Act & Assert
            await expectAsync(service.create(invalidDto))
                .toBeRejectedWithError(ValidationError, '名稱不能為空');
        ...
        it('當儲存庫拋出錯誤時應該處理錯誤', async () => {
            ...
            // Act & Assert
            await expectAsync(service.create(createDto))
                .toBeRejectedWithError(ApplicationError, '創建失敗');
    ...
    describe('getById', () => {
        ...
        it('當 ID 為空時應該拋出 ValidationError', async () => {
            // Act & Assert
            await expectAsync(service.getById(''))
                .toBeRejectedWithError(ValidationError, 'ID 不能為空');
    ...
    describe('update', () => {
        ...
        it('當實體不存在時應該拋出 NotFoundError', async () => {
            ...
            // Act & Assert
            await expectAsync(service.update('non-existent-id', updateDto))
    ...
    describe('delete', () => {
        ...
        it('當實體不存在時應該拋出 NotFoundError', async () => {
            ...
            // Act & Assert
            await expectAsync(service.delete('non-existent-id'))
                .toBeRejectedWithError(NotFoundError, '實體不存在');
