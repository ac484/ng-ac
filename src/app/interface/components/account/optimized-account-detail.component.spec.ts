...
describe('OptimizedAccountDetailComponent', () => {
  ...
  beforeEach(async () => {
    const accountServiceSpy = jasmine.createSpyObj('OptimizedAccountApplicationService', ['getAccountById', 'getRecentTransactions']);
    ...
    await TestBed.configureTestingModule({
      imports: [OptimizedAccountDetailComponent, NoopAnimationsModule],
      providers: [
