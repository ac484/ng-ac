...
import { OptimizedAccountApplicationService, AccountResponseDto, DepositDto, WithdrawDto, TransferDto } from '../../../application/services/optimized-account-application.service';
...
describe('AccountTransactionModalComponent', () => {
    ...
    describe('Form Submission', () => {
        ...
        it('should handle deposit submission successfully', async () => {
            component.transactionType = 'deposit';
            spyOn(component as any, 'handleDeposit').and.returnValue(Promise.resolve({
                success: true,
                message: '存款成功',
        ...
        it('should handle withdraw submission successfully', async () => {
            component.transactionType = 'withdraw';
            spyOn(component as any, 'handleWithdraw').and.returnValue(Promise.resolve({
                success: true,
                message: '提款成功',
                updatedAccount: mockAccount
            }));
        ...
        it('should handle transfer submission successfully', async () => {
            component.transactionType = 'transfer';
            spyOn(component as any, 'handleTransfer').and.returnValue(Promise.resolve({
                success: true,
                message: '轉帳成功',
                updatedAccount: mockAccount,
