      ...
      <nz-card class="stats-card" nzTitle="帳戶統計">
        <nz-row [nzGutter]="16">
          <nz-col [nzSpan]="6">
            <nz-statistic
              nzTitle="總帳戶數"
              [nzValue]="accountStats.totalAccounts"
          ...
          <nz-col [nzSpan]="6">
            <nz-statistic
              nzTitle="啟用帳戶"
              [nzValue]="accountStats.activeAccounts"
          ...
          <nz-col [nzSpan]="6">
            <nz-statistic
              nzTitle="總餘額"
              [nzValue]="accountStats.totalBalance"
          ...
          <nz-col [nzSpan]="6">
            <nz-statistic
              nzTitle="平均餘額"
              [nzValue]="accountStats.averageBalance"
    ...
    async loadAccountStats(): Promise<void> {
        try {
            ...
            this.accountStats = {
                ...
                averageBalance: this.accounts.length > 0
                    ? this.accounts.reduce((sum, a) => sum + a.balance, 0) / this.accounts.length
                    : 0
            };
        } catch (error) {
