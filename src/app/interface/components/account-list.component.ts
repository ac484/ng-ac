    ...
    <div class="account-list-container">
      ...
      <nz-card class="stats-card">
        <div class="stats-grid">
          <nz-statistic
            nzTitle="Total Accounts"
            [nzValue]="accountStats.total"
            [nzValueStyle]="{ color: '#3f8600' }">
          </nz-statistic>
          <nz-statistic
            nzTitle="Active Accounts"
            [nzValue]="accountStats.active"
          ...
          <nz-row [nzGutter]="16">
            ...
            <nz-col [nzSpan]="2">
              <button
                ...
                (click)="addAccount()"
                nz-tooltip
                nzTooltipTitle="Add New Account">
