...
describe('DataTableComponent Integration', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NoopAnimationsModule, DataTableComponent],
    ...
    const dataTableDebugElement = fixture.debugElement.query(de => de.componentInstance instanceof DataTableComponent);
