...
@Component({
  ...
  template: `
    <div class="form-modal">
      ...
      <form 
        nz-form 
        [formGroup]="form" 
        [nzLayout]="data.layout || 'vertical'">
        
        <div class="form-fields">
          <div 
            *ngFor="let field of data.fields" 
            [class]="'form-field-wrapper span-' + (field.span || 24)">
  ...
  styles: [`
    ...
    .form-field-wrapper.span-24 { width: 100%; }
    .form-field-wrapper.span-12 { width: 50%; }
    .form-field-wrapper.span-8 { width: 33.333%; }
    .form-field-wrapper.span-6 { width: 25%; }
