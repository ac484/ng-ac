    ...
    <div class="modal-examples">
      <nz-card nzTitle="模態框服務使用範例">
        ...
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showBasicConfirm()">
            基本確認
          </button>
          <button nz-button nzType="default" nzDanger (click)="showDeleteConfirm()">
            刪除確認
          </button>
          <button nz-button nzType="default" (click)="showWarningConfirm()">
            警告確認
          </button>
        </nz-space>
        ...
        <h3>資訊對話框</h3>
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showInfo()">
            資訊
          </button>
          <button nz-button nzType="primary" (click)="showSuccess()">
            成功
          </button>
          <button nz-button nzType="primary" nzDanger (click)="showError()">
            錯誤
          </button>
          <button nz-button nzType="default" (click)="showWarning()">
            警告
          </button>
        </nz-space>
        ...
        <h3>表單對話框</h3>
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showSimpleForm()">
            簡單表單
          </button>
          <button nz-button nzType="default" (click)="showComplexForm()">
            複雜表單
          </button>
          <button nz-button nzType="default" (click)="showUserForm()">
            用戶表單
          </button>
        </nz-space>
        ...
        <h3>載入對話框</h3>
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showBasicLoading()">
            基本載入
          </button>
          <button nz-button nzType="default" (click)="showProgressLoading()">
            進度載入
          </button>
          <button nz-button nzType="default" (click)="showDotsLoading()">
            點點載入
          </button>
        </nz-space>
        ...
        <h3>自定義對話框</h3>
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showCustomConfirmation()">
            自定義確認
          </button>
          <button nz-button nzType="default" (click)="showCustomForm()">
            自定義表單
          </button>
          <button nz-button nzType="default" (click)="showCustomLoading()">
            自定義載入
          </button>
        </nz-space>
        ...
        <h3>進階功能</h3>
        <nz-space nzSize="small">
          <button nz-button nzType="primary" (click)="showProgressWithUpdates()">
            動態進度更新
          </button>
          <button nz-button nzType="default" (click)="showChainedModals()">
            連續對話框
          </button>
          <button nz-button nzType="default" nzDanger (click)="closeAllModals()">
            關閉所有對話框
          </button>
        </nz-space>
