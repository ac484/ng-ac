...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, NzButtonModule, NzIconModule, NzSpaceModule],
  template: `
    <div class="confirmation-modal">
      <div class="confirmation-header">
        <span nz-icon [nzType]="getIcon()" [class]="'confirmation-icon ' + getIconClass()"> </span>
      ...
      <div class="confirmation-actions">
        <nz-space nzSize="small">
          <button nz-button nzType="default" (click)="onCancel()" [nzLoading]="loading">
            {{ data.cancelText || '取消' }}
          </button>
          <button nz-button [nzType]="getButtonType()" [nzDanger]="data.type === 'error'" (click)="onConfirm()" [nzLoading]="loading">
            {{ data.confirmText || '確定' }}
          </button>
        </nz-space>
      </div>
