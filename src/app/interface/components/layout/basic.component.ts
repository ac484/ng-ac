      ...
      <ng-template #asideUserTpl>
        ...
        <nz-dropdown-menu #userMenu="nzDropdownMenu">
          <ul nz-menu>
            ...
            <li nz-menu-item routerLink="/accounts">{{ 'menu.accounts' | i18n }}</li>
            <li nz-menu-item routerLink="/transactions">{{ 'menu.transactions' | i18n }}</li>
            <li nz-menu-item routerLink="/users">{{ 'menu.users' | i18n }}</li>
