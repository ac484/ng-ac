...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, MatCardModule, MatButtonModule, MatIconModule, ContractsDashboardStatsComponent, ContractsTableComponent],
  template: `
    <div class="contracts-page">
      <div class="page-header">
        <h1>合約管理</h1>
        <div class="header-actions">
          <button mat-raised-button color="primary" (click)="openAiSummarizer()"><mat-icon>smart_toy</mat-icon>AI 合約摘要</button>
          <button mat-raised-button color="accent"><mat-icon>add</mat-icon>新增合約</button>
        </div>
      </div>
  ...
  `,
  styles: [`
    .contracts-page{padding:24px;max-width:1200px;margin:0 auto}
