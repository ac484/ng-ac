...
describe('ModalService', () => {
    ...
    beforeEach(() => {
        const nzModalSpy = jasmine.createSpyObj('NzModalService', [
            'confirm',
            'info',
            'create',
            'closeAll'
    ...
    describe('confirm', () => {
        it('should call nzModalService.confirm with correct parameters', async () => {
            ...
            expect(nzModalService.confirm).toHaveBeenCalledWith(jasmine.objectContaining({
    ...
    describe('openForm', () => {
        it('should create form modal', () => {
            ...
            expect(nzModalService.create).toHaveBeenCalledWith(jasmine.objectContaining({
                nzTitle: 'Form Title',
    ...
    describe('success', () => {
        it('should show success dialog', async () => {
            ...
            expect(nzModalService.info).toHaveBeenCalledWith(jasmine.objectContaining({
                nzTitle: title,
                nzContent: content,
